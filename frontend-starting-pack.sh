...
# Git installation
echo
echo -e "1/11 ${LCYAN}Git installation... ${NC}"
echo
git init

# ESLint & Prettier installation
echo
echo -e "2/11 ${LCYAN}ESLint & Prettier installation... ${NC}"
echo
npm install -D eslint prettier

# Airbnb's JavaScript style guide packages installation
echo
echo -e "3/11 ${LCYAN}Airbnb's JavaScript style guide packages installation... ${NC}"
echo
...
echo
echo -e "4/11 ${LCYAN}Prettier's Eslint packages installation... ${NC}"
echo
npm install -D eslint-config-prettier eslint-plugin-prettier

# Building eslintrc.json file
echo
echo -e "5/11 ${LCYAN}Building eslintrc.json file...${NC}"
...
echo -e "6/11 ${LCYAN}Building your prettierrc.json file... ${NC}"
...
echo -e "8/11 ${LCYAN}Building pack folders and files... ${NC}"
mkdir "css"
mkdir "img"
mkdir "js"
touch "js/main.js"
...
echo -e "9/11 ${LCYAN}Building gitignore file... ${NC}"
...
echo -e "10/11 ${LCYAN}Building your style.scss file... ${NC}"
...
echo
echo -e "11/11 ${LCYAN}Removing the script file... ${NC}"
echo
rm frontend-starting-pack.sh
